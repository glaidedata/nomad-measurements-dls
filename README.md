# nomad-measurements-dls

NOMAD measurements plugin for Dynamic Light Scattering and Zeta Potential
...
```sh
git clone https://github.com/abbasgholami71/nomad-measurements-dls.git
cd nomad-measurements-dls
